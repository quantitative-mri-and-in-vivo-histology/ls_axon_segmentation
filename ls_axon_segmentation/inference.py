...
# - combined monai.inferers.utils.sliding_window_inference and monai.inferers.SlidingWindowInferer into one file
# - added option to show progress_bar to sliding_window_inference and SlidingWindowInferer
# - modified default overlap to 0.5
...
__all__ = ["sliding_window_inference", "SlidingWindowInferer"]
...
def sliding_window_inference(
    ...
    **kwargs: Any,
    ...
    all_slices_range = range(0, total_slices, sw_batch_size)
    if show_progress:
        all_slices_range = tqdm.tqdm(all_slices_range)

    for slice_g in all_slices_range:
